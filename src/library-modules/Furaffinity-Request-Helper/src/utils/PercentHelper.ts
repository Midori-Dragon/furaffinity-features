export class PercentHelper {
    ...
    static setPercentValue(id: string | number, value: number): boolean {
    ...
    static getPercentValue(id?: string | number, decimalPlaces = 2): number {
    ...
    static createPercentValue(uniqueId: string | number): void {       
        // Initialize the percent value at 0 for the given uniqueId
        PercentHelper._percentAll[uniqueId] = 0;
    }

    static deletePercentValue(id: string | number): void {
    ...
    static updatePercentValue(id: string | number | undefined, value: number, totalValue: number): void {
        if (id != null && id !== '' && id !== -1) {
